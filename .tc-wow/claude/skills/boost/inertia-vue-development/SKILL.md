...
When building empty states (no data, no results, first-time use), use `/trilogy-illustrate` to select an appropriate undraw.co illustration. Import SVGs from `@/Assets/Common/undraw_[name].svg`.
