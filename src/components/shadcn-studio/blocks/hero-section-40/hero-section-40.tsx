        ...
        <div className='mx-auto flex max-w-7xl flex-col gap-6 border-x px-4 py-8 sm:px-6 sm:py-16 lg:px-8 lg:py-24'>
          <div className='flex flex-col items-center gap-4 text-center'>
            ...
            <div className='flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8'>
              <PrimaryOrionButton size='lg' className='rounded-lg max-[425px]:has-[>svg]:px-4' render={<a href='/process' />}>
                <ArrowUpRightIcon />See the Process
              </PrimaryOrionButton>
              <SecondaryOrionButton size='lg' className='rounded-lg max-[425px]:has-[>svg]:px-4' render={<a href='/dashboard' />}>
                View Initiatives
