...
flowchart TB
    ...
    subgraph GENERATE["Generate Notes"]
        direction LR
        g1["/trilogy-release-notes"] --> g2[Summarize for Business]
...
## The /trilogy-release-notes Skill

Use `/trilogy-release-notes` to automate release note generation. It analyses the deployment PR from GitHub and extracts all commits to produce a summary addressed to multiple audiences.
...
- [Skills Reference](/ways-of-working/spec-driven-development/09-skills-reference)
