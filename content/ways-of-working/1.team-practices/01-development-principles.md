...
Documentation lives close to code. Specs are in `.tc-docs/content/initiatives/`, not in forgotten wiki pages. Context compounds when it's accessible.
...
└── meta.yaml            # Linear sync and metadata
```
