...
| Skill | Purpose | Gate |
|-------|---------|------|
| `trilogy-dev-pr` | Lint, format, simplify, type-check, test, review, and create PR targeting `dev` | Code Gate (4) |
| `trilogy-dev-handover` | Full Gate 4 validation with Linear transition (Dev → QA) | Code Gate (4) |
...
| Create PR | `/trilogy-dev-pr` |
| Ship release | `/trilogy-ship` |
...
# Release workflow
/trilogy-dev-pr → /trilogy-qa → /trilogy-ship
```
