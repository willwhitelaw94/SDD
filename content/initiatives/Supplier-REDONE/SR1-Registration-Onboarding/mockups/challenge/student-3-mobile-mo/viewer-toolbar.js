(function() {
  ...
  tb.innerHTML='<div class="bg-gray-800/95 backdrop-blur border-b border-gray-700 px-4 py-3"><div class="max-w-7xl mx-auto flex items-center justify-between"><div class="flex items-center gap-4"><div class="flex items-center gap-2"><div class="w-6 h-6 bg-[#007F7E] rounded flex items-center justify-center text-xs font-bold text-white">TC</div><h1 class="text-base font-semibold text-white">SR1 Registration \u2014 Mobile Mo</h1></div><span class="text-gray-600">|</span><span class="text-gray-400 text-sm">'+String(screens[ci].id).padStart(2,'0')+' \u2014 '+screens[ci].short+'</span></div><span class="text-xs text-gray-500">'+(ci+1)+' / '+screens.length+'</span></div></div><div class="bg-gray-800/80 backdrop-blur px-4 py-2 border-b border-gray-700/50"><div class="max-w-7xl mx-auto flex items-center gap-1.5 overflow-x-auto">'+btns+'</div></div>';
