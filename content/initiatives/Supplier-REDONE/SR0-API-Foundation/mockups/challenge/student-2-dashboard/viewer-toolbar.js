...
(function() {
  const screens = [
    { id: 1, short: 'Login', file: '01-login.html' },
    { id: 2, short: 'Account Switcher', file: '02-account-switcher.html' },
    { id: 3, short: 'Error States', file: '03-error-states.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">SR0 — Dashboard Dan</h1>
          </div>
  ...
  figmaAllBtn.addEventListener('click', function() { /* simplified: just copy current */ copyToFigma(); });
