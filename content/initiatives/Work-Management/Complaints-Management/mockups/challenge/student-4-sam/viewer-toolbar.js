...
(function() {
  ...
  const screens = [
    { id: 1, short: 'Split Index',    file: '01-index.html' },
    { id: 2, short: 'Package Tab',    file: '02-package-tab.html' },
    { id: 3, short: 'Detail View',    file: '03-detail-view.html' },
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Feedback Records — Sidebar Sam</h1>
          </div>
