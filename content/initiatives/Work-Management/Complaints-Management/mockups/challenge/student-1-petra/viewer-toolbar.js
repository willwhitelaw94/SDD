...
//
// Project: Feedback Records — Pyramid Petra
//
(function() {
  // Skip toolbar when loaded inside an iframe (challenge viewer handles navigation)
  if (window !== window.top) return;
  const screens = [
    { id: 1, short: 'Pyramid Dashboard', file: '01-index.html' },
    ...
    { id: 5, short: 'Notes Timeline', file: '05-notes-section.html' },
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Feedback Records — Pyramid Petra</h1>
          </div>
