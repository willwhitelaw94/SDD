...
//
// Project: Feedback Records — Unified Design
//
(function() {
  if (window !== window.top) return;

  const screens = [
    { id: 1, short: 'Index', file: '01-index.html' },
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Feedback Records — Unified Design</h1>
          </div>
