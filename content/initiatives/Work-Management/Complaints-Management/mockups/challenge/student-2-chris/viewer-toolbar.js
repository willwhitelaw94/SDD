...
(function() {
  ...
  const screens = [
    { id: 1, short: 'Register', file: '01-index.html' },
    { id: 2, short: 'Package Tab', file: '02-package-tab.html' },
    { id: 3, short: 'Record Detail', file: '03-detail-view.html' },
    { id: 4, short: 'Create Form', file: '04-create-form.html' },
    { id: 5, short: 'SOAP Notes', file: '05-notes-section.html' },
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Feedback Records — Clinical Chris</h1>
          </div>
