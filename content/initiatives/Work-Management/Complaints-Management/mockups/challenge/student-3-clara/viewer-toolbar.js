...
(function() {
  ...
  const screens = [
    { id: 1, short: 'Kanban Board', file: '01-index.html' },
    { id: 2, short: 'Package Board', file: '02-package-tab.html' },
    { id: 3, short: 'Card Detail', file: '03-detail-view.html' },
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Feedback Records — Canvas Clara</h1>
          </div>
