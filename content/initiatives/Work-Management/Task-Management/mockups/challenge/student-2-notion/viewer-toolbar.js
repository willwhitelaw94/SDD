...
//
// TEMPLATE USAGE:
//   Replace Task Management V2 — Notion Nate with the epic/feature name
//   Replace {{SCREENS}} with the screens array for this mockup set
//
(function() {
  const screens = [
    { id: 1, short: 'Task List', file: '01-task-list.html' },
    { id: 2, short: 'Kanban', file: '02-kanban-board.html' },
    { id: 3, short: 'Dialog', file: '03-task-dialog.html' },
    { id: 4, short: 'Inline Edit', file: '04-inline-editing.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Task Management V2 — Notion Nate</h1>
          </div>
