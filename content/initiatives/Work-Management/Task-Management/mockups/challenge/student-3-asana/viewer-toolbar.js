// Shared Mockup Viewer Toolbar — Task Management V2 — Asana Ada
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            <div class="w-6 h-6 bg-pink-600 rounded flex items-center justify-center text-xs font-bold text-white">A</div>
            <h1 class="text-base font-semibold text-white">Task Management V2 — Asana Ada</h1>
          </div>
