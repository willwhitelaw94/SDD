...
Run `/trilogy-dev-pr` to lint, type-check, test, review, and create a PR targeting `dev`. Or run `/trilogy-dev-handover` for full Gate 4 validation with Linear transition.
