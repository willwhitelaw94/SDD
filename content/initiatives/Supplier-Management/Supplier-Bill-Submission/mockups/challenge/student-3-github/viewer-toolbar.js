...
//
// TEMPLATE USAGE:
//   Replace Invoice Uplift — GitHub Gary with the epic/feature name (e.g. "Lead Essential (LES)")
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Invoice Uplift — GitHub Gary</h1>
          </div>
