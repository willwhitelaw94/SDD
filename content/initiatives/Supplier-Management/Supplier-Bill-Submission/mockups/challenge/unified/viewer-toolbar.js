// Shared Mockup Viewer Toolbar — Unified Design (Supplier Invoice Uplift)
...
(function() {
  const screens = [
    ...
    { id: 3, short: 'Invoice Detail', file: '03-invoice-detail.html' },
    { id: 4, short: 'Create Invoice', file: '04-invoice-create.html' },
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Supplier Invoice Uplift — Unified</h1>
          </div>
  ...
  hints.innerHTML = `
    ...
    <span><kbd class="bg-gray-700 px-1.5 py-0.5 rounded text-gray-400 font-mono text-[10px]">1</kbd>–<kbd class="bg-gray-700 px-1.5 py-0.5 rounded text-gray-400 font-mono text-[10px]">7</kbd> Jump</span>
    <span class="text-gray-700">|</span>
