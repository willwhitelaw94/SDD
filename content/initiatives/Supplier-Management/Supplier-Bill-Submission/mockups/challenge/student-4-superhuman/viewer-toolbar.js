...
//
// TEMPLATE USAGE:
//   Replace Invoice Uplift — Superhuman Sam with the epic/feature name (e.g. "Lead Essential (LES)")
...
(function() {
  const screens = [
    ...
    { id: 2, short: 'Invoices', file: '02-invoices-list.html' },
    { id: 3, short: 'Detail', file: '03-invoice-detail.html' },
    { id: 4, short: 'Create', file: '04-invoice-create.html' },
    { id: 5, short: 'Clients', file: '05-clients.html' },
    { id: 6, short: 'In Tray', file: '06-in-tray.html' },
    { id: 7, short: 'Public Form', file: '07-public-form.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Invoice Uplift — Superhuman Sam</h1>
          </div>
