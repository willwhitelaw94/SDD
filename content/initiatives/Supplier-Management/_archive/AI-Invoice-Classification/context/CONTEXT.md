---
title: "AI Invoice Classification Epic - Context & Decisions"
---
...
- **Decision**: Created new epic for AI Invoice Classification (separate from TP-3300 Invoice Recode)
...
|-------|----------|-------|
| Phase 1 | January | Core AI classification, breadcrumb UI, scoped selection, multi-service detection |
| Phase 2 | February | Top 200 supplier refinements, retrospective batch classification, analytics |
...
- **TP-3300-REC** (Invoice Recode Tool) - Manual bulk recode functionality; complements this AI classification epic
- **TP-2323-AIV3** (AI Invoice V3) - Empty/legacy epic
...
- [idea.md](../idea.md) - Epic idea brief
