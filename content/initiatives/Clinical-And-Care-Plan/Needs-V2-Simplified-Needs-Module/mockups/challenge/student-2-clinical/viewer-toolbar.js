...
//
// TEMPLATE USAGE:
//   Replace Needs V2 — Clinical Chris with the epic/feature name (e.g. "Lead Essential (LES)")
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Needs V2 — Clinical Chris</h1>
          </div>
