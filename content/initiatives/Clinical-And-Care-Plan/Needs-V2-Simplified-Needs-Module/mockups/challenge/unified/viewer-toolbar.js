...
//
// TEMPLATE USAGE:
//   Replace Needs V2 — Unified Design with the epic/feature name (e.g. "Lead Essential (LES)")
//   Replace { id: 1, short: 'Needs List', file: '01-needs-list.html' },
    { id: 2, short: 'Create Need', file: '02-create-need.html' },
    { id: 3, short: 'Need Detail', file: '03-need-detail.html' }, with the screens array for this mockup set
//
// Example { id: 1, short: 'Needs List', file: '01-needs-list.html' },
    { id: 2, short: 'Create Need', file: '02-create-need.html' },
    { id: 3, short: 'Need Detail', file: '03-need-detail.html' }, replacement:
...
(function() {
  const screens = [
    { id: 1, short: 'Needs List', file: '01-needs-list.html' },
    { id: 2, short: 'Create Need', file: '02-create-need.html' },
    { id: 3, short: 'Need Detail', file: '03-need-detail.html' },
  ];
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <h1 class="text-base font-semibold text-white">Needs V2 — Unified Design</h1>
          </div>
